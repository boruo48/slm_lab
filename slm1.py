...
# img = cv2.imread("./isoumidori-/13/phase_100.png", cv2.IMREAD_GRAYSCALE)
# img = cv2.imread("./isoumidori-/19/phase_50.png", cv2.IMREAD_GRAYSCALE)
# img = cv2.imread("./isoumidori-/19/phase_100.png", cv2.IMREAD_GRAYSCALE)
# img = cv2.imread("./isoumidori-/18/phase_50.png", cv2.IMREAD_GRAYSCALE)
